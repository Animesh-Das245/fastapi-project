...
def test_vote_on_post_twice(authorised_client,test_posts,test_vote):
    res = authorised_client.post('/vote',json={"post_id":test_posts[3].id,"dir":1})
...
def test_vote_non_exist(authorised_client):
    res = authorised_client.post('/vote',json={"post_id":8888888,"dir":1})
